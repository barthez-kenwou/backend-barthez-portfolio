 ...
 *   node infra/scripts/scaffold/module.mjs orders --wire
 *
 * Options:
...
function printHelp() {
  console.log(`
Scaffold a Barthez Kenwou Portfolio Backend domain module (full vertical slice).
...
function printBanner(names, opts) {
  console.log(`
┌──────────────────────────────────────────────────────────┐
│  Barthez Kenwou Portfolio Backend — module scaffold                          │
├──────────────────────────────────────────────────────────┤
